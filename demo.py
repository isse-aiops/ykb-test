...
class TestJS: #https://www.jianshu.com/p/7b760e2db555
    ...
    def setup(self):
        ...
        self.driver = webdriver.Edge(executable_path='..\driver\msedgedriver-96.0.1054.29-stable.exe',options=self.opt)
        self.driver.maximize_window()
        self.driver.implicitly_wait(5)
        
        # 添加cookie的域名需要设置对,先访问
        self.driver.get('https://auth.cq.gov.cn:81/sso/login?utype=0&client_id=OCTVFKMB0') #解决domain报错https://www.cnblogs.com/deliaries/p/14121204.html
        self.driver.delete_cookie('JSESSIONID') #需删除
        self.driver.add_cookie({'name':'JSESSIONID','value':'inspurdd426acf8d27462a9f1de5fd58cd9cca','domain':'auth.cq.gov.cn','path':'/'})
    ...
    def performance2mysql(self,url="https://zwykb.cq.gov.cn/grbs/",mysqlurl="10.236.101.17/3306/root/123456/performancedb/TB_performance2"):
...
if __name__ == "__main__":
    ...
    #ts.performance2mysql(url='https://zwykb.cq.gov.cn/ggbf_search/ljbl/?mainKey=aa4fc5f3-36c0-4c8a-9ac1-fbaaa2ebc8e1&type=08&parentPage=1')
    #ts.performance2mysql(url='https://zwykb.cq.gov.cn/ggbf_search/ljbl/?mainKey=f4943a42-961d-47db-a86c-b1ada64370ab&type=01&parentPage=1')
    count = 0
    for i in range(200):
        try:
            ts.performance2mysql(url='https://zwykb.cq.gov.cn/ggbf_search/ljbl/?mainKey=f4943a42-961d-47db-a86c-b1ada64370ab&type=01&parentPage=1')
